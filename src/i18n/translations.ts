...
export const translations: Record<Language, Translation> = {
  en: {
    ...
    portfolio: {
      ...
      project1Title: "Mostafa Grocery",
      project1Category: "Grocery Delivery Platform",
      project2Title: "Gaber Real Estate",
      project2Category: "Real Estate Listings",
      project3Title: "Sameh Hotel Booking",
      project3Category: "Hotel Booking System",
      project4Title: "Prescripto",
      ...
      items: [
        {
          ...
          role: "Owner, Mostafa Grocery",
          text: "The grocery delivery site made taking orders much easier for me. Customers can find what they need quickly, and I can manage everything without getting lost in messages.",
          rating: 5,
        },
        {
          name: "Marwan Gaber",
          role: "Owner, Gaber Real Estate",
          text: "I wanted a simple place to show apartments and offers, and that is exactly what I got. The site looks clean and clients now reach the right listings much faster.",
          rating: 5,
        },
        {
          name: "El Hagg Sameh",
          role: "Owner, Sameh Hotel",
          text: "The booking system saved us a lot of back and forth. Guests can see the details and send their booking easily, and our team can follow up with every reservation.",
          rating: 5,
        },
        {
          name: "Yasmin Fathy",
          role: "Owner, Fathy Clinic",
          text: "The appointment website feels professional but is still easy for patients to use. We started receiving organized booking requests from day one.",
          rating: 5,
        },
      ],
    },
  ...
  ar: {
    ...
    portfolio: {
      ...
      project1Title: "بقالة مصطفى",
      project1Category: "منصة توصيل بقالة",
      project2Title: "عروض جابر العقارية",
      project2Category: "عروض وعقارات",
      project3Title: "حجوزات فندق سامح",
      project3Category: "نظام حجوزات فنادق",
      project4Title: "بريسكريبتو",
    ...
    testimonials: {
      ...
      items: [
        {
          name: "مصطفى السيد",
          role: "صاحب بقالة مصطفى",
          text: "موقع توصيل البقالة سهّل عليا استقبال الطلبات جداً. الزباين بقت تلاقي اللي محتاجاه بسرعة وأنا بقدر أتابع كل حاجة من غير لخبطه رسايل.",
          rating: 5,
        },
        {
          name: "مروان جابر",
          role: "صاحب مكتب جابر للعقارات",
          text: "كنت محتاج مكان بسيط أعرض فيه الشقق والعروض، وده اللي حصل بالظبط. الموقع شكله نضيف والعميل بيوصل للعقار المناسب أسرع بكتير.",
          rating: 5,
        },
        {
          name: "الحاج سامح",
          role: "صاحب فندق سامح",
          text: "نظام الحجوزات وفر علينا كلام كتير رايح جاي. النزيل بيشوف التفاصيل ويبعت حجزه بسهولة، وفريقنا بيتابع كل حجز من مكان واحد.",
          rating: 5,
        },
        {
          name: "ياسمين فتحي",
          role: "صاحبة عيادة فتحي",
          text: "موقع حجز المواعيد شكله احترافي وفي نفس الوقت سهل للمرضى. من أول يوم بدأنا نستقبل طلبات حجز مرتبة وواضحة.",
          rating: 5,
        },
      ],
    },
