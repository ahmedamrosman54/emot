...
export function Pricing() {
  ...
  const addons = [
    ...
    {
      text: t.pricing.addon2,
      price: t.pricing.addon2Price,
      icon: Plus,
      color: "cyber",
    },
    {
      text: t.pricing.addon3,
      price: t.pricing.addon3Price,
      icon: Plus,
      color: "crimson",
    },
  ];
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {packages.map((pkg, i) => (
            ...
            >
              ...
              {/* Package name */}
              <h3 className="mt-4 font-mono text-xl font-bold text-white">
                {pkg.name}
              </h3>

              {/* Price */}
              <div className="mt-4 flex items-baseline gap-1">
                <span className="font-mono text-5xl font-bold text-gradient-neon">
                  {pkg.price}
                </span>
